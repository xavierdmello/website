    ...
    <div>
      <div className="fixed z-[11] p-4 w-full flex flex-row justify-between">
        ...
        <a
          ...
          className={`w-12 h-12 sm:w-24 sm:h-24 bg-highlight border-[1px] border-black grid place-content-center hover:bg-black hover:text-white duration-500 transition-all`}
        >
