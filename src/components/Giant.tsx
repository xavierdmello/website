  ...
  return (
    <div>
      {props.onHover === undefined ? (
        ...
        >
          <div className="w-56 sm:w-72 h-6 sm:h-7 top-6 sm:top-7 3xl:w-[600px] 3xl:h-12 3xl:top-[60px] float-right bg-secondary text-right opacity-0 group-hover:opacity-100 absolute transition-all duration-300 -z-10"></div>
          {props.text}
        </h1>
      ) : (
        <h1
        ...
        >
          <div className="w-72 h-7 top-7 3xl:w-[600px] 3xl:h-10 3xl:top-14 float-right bg-secondary text-right opacity-0 group-hover:opacity-100 absolute transition-all duration-300 -z-10"></div>
          {props.text}
        </h1>
      )}
    </div>
